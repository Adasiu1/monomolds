...
const pages: Record<string, ContentPage> = {
  ...
  "polityka-prywatnosci": {
    ...
    sections: [
      ...
      { heading: "4. Odbiorcy danych", body: <><p>W działającym sklepie dane techniczne i dane zamówień mogą być przetwarzane przez dostawców hostingu i infrastruktury: Vercel oraz Supabase. Dane potrzebne do dostawy mogą zostać przekazane wybranemu przewoźnikowi InPost.</p><p>Dostawca płatności i system wysyłki e-mail zostaną dopisani jako odbiorcy dopiero po uruchomieniu tych integracji. Nie sprzedajemy danych osobowych.</p></> },
