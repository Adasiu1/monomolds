...
values
  ('00000000-0000-0000-0000-000000000001', 'product', 'monkey', 'Monkey', 'Forma do monoporcji Monkey.', 4999, 'PLN', 10, 'published'),
  ('00000000-0000-0000-0000-000000000002', 'product', 'heart', 'Heart', 'Forma do monoporcji Heart.', 4499, 'PLN', 8, 'published'),
  ('00000000-0000-0000-0000-000000000003', 'product', 'cube', 'Cube', 'Forma do monoporcji Cube.', 3999, 'PLN', 15, 'published'),
...
values
  ('00000000-0000-0000-0000-000000000011', '00000000-0000-0000-0000-000000000001', 'variant', 'Monkey - 6 szt.', 4999, 'PLN', 10, 'published'),
  ('00000000-0000-0000-0000-000000000012', '00000000-0000-0000-0000-000000000001', 'variant', 'Monkey - 12 szt.', 7999, 'PLN', 5, 'published');
