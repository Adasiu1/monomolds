...
export function Price({ amountGrosze, originalAmountGrosze, lowest30DaysGrosze, prefix }: PriceProps) {
  ...
  return <div className="ui-price">
    <span><span className="sr-only">{sale ? "Cena promocyjna: " : "Cena: "}</span>{prefix ? `${prefix} ` : null}{current}</span>
